...
public class MajajiModel extends EntityModel<MajajiEntityRenderState> {
  public static final EntityModelLayer MAJAJI = new EntityModelLayer(Identifier.of(ModDia1.MOD_ID, "majaji"), "main");
    ...
    public MajajiModel(ModelPart root) {
    ...
    @Override
    public void setAngles(MajajiEntityRenderState majajiEntityRenderState) {
      super.setAngles(majajiEntityRenderState);
    }
